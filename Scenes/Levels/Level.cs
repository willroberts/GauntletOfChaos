...
public partial class Level : TileMap
{
    ...
    private Array<Vector2I> _DoorTiles = new();
    public void SetDoorTiles(Array<Vector2I> tiles) { _DoorTiles = tiles; }
    public Array<Vector2I> GetDoorTiles() { return _DoorTiles; }
